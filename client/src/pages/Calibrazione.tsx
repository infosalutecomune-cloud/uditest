...
import { CALIBRAZIONE_AUDIO_URL } from '@/lib/testData';
...
export default function Calibrazione() {
  ...
  async function misuraAmbiente() {
    ...
    try {
      ...
      // Usa TimeDomain per calcolare RMS reale del segnale audio
      ...
      const tick = () => {
        ...
        // Calcola RMS: ogni byte è 0-255 con 128 come zero
        let sumSq = 0;
        for (let i = 0; i < data.length; i++) {
          const normalized = (data[i] - 128) / 128; // -1.0 a +1.0
          sumSq += normalized * normalized;
        }
        const rms = Math.sqrt(sumSq / data.length);
        // Converti RMS in dB (0 dBFS = RMS 1.0)
        // Mappa su scala 30-80 dB SPL approssimativa
        const dBFS = rms > 0 ? 20 * Math.log10(rms) : -60;
        // dBFS va da -60 (silenzio) a 0 (massimo)
        // Mappa su scala percettiva 30-80 dB SPL
        ...
        if (Date.now() - startTime < 3000) {
          ...
          // Usa il 75° percentile per ignorare picchi isolati
          const sorted = [...samples].sort((a, b) => a - b);
          const p75 = sorted[Math.floor(sorted.length * 0.75)];
          pulisciMic();
          // Soglia: silenzio < 45 dB, rumoroso >= 45 dB
          if (p75 <= 45) {
            setDbLevel(p75);
            setStatoAmbiente('ok');
          } else {
  ...
  // ── Riproduzione tono calibrazione ──
  function riproduciTono() {
    if (audioRef.current) {
      audioRef.current.pause();
      audioRef.current.currentTime = 0;
    }
    const audio = new Audio(CALIBRAZIONE_AUDIO_URL);
    audioRef.current = audio;
    setStatoVolume('riproducendo');
    audio.play().catch(() => setStatoVolume('attesa'));
    audio.onended = () => setStatoVolume('attesa');
  }
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      <AppHeader
        onBack={() => {
          pulisciMic();
          stopTono();
          if (currentStep === 'posizione') setStep('scelta-audio');
              ...
              <div className="card-voicecheck">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#EBF4FC]">
                    ...
                    <div>
                      <p className="font-extrabold text-[#1E293B] text-base mb-1">
                        Tieni il telefono vicino
                      </p>
                      <p className="text-[#64748B] text-sm leading-relaxed">
                        Tienilo a <strong>30–50 cm</strong> dal viso — abbastanza vicino da sentire
                        l'audio chiaramente e da poter premere i tasti comodamente.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#F0FDF4]">
                    ...
                    <div>
                      ...
                      <p className="text-[#64748B] text-sm leading-relaxed">
                        Se hai le cuffie, indossale. Migliorano la precisione del test
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#FFFBEB]">
                    ...
                    <div>
                      ...
                      <p className="text-[#64748B] text-sm leading-relaxed">
                        Siediti in un posto tranquillo. Spegni TV, radio e riduci
            ...
            <>
              <div className="card-voicecheck text-center">
                ...
                <p className="text-[#64748B] text-base mb-6">
                  ...
                  Misureremo il rumore di fondo della stanza.
                </p>
                ...
                {statoAmbiente === 'misurando' && (
                  <div className="py-4">
                    <p className="text-[#F59E0B] font-extrabold text-lg animate-pulse">
                      Silenzio... misuro...
                    </p>
                ...
                {statoAmbiente === 'ok' && (
                  <div className="space-y-4">
                    <div className="bg-[#F0FDF4] rounded-2xl p-4">
                      <p className="font-extrabold text-[#166534] text-lg">
                        Ambiente silenzioso ✓
                      </p>
                      <p className="text-[#64748B] text-sm mt-1">
                        Il rumore di fondo è basso. Ottimo per il test!
                      </p>
                    </div>
                    <button
                      className="btn-primary"
                ...
                {statoAmbiente === 'rumoroso' && (
                  <div className="space-y-4">
                    <div className="bg-[#FEF2F2] rounded-2xl p-4">
                      <p className="font-extrabold text-[#991B1B] text-lg">
                        Ambiente rumoroso
                      </p>
                      <p className="text-[#64748B] text-sm mt-1">
                        C'è troppo rumore intorno. I risultati potrebbero essere meno precisi.
                        Prova a spostarti in un posto più silenzioso.
                      </p>
                    </div>
                    <button
                      className="btn-primary"
                ...
                {statoAmbiente === 'errore' && (
                  <div className="space-y-4">
                    <div className="bg-[#FFFBEB] rounded-2xl p-4">
                      <p className="font-extrabold text-[#92400E] text-base">
                        Microfono non accessibile
                      </p>
                      <p className="text-[#64748B] text-sm mt-1">
                        Abilita il permesso microfono nelle impostazioni del browser.
                      </p>
                    </div>
                    <button
            ...
            <>
                ...
                <>
                  ...
                  <div className="card-voicecheck">
                    ...
                    <p className="text-[#64748B] text-base mb-5">
                      Premi il pulsante e ascolta il tono. Poi dimmi se lo hai sentito chiaramente.
                    </p>
                    <div className="flex flex-col items-center gap-4">
                      <div className="relative">
                        ...
                        <button
                          onClick={statoVolume === 'riproducendo' ? stopTono : riproduciTono}
              ...
              {statoVolume === 'sentito' && (
                <div className="card-voicecheck text-center py-8 animate-fade-in-up">
                  ...
                  <p className="text-[#64748B] text-base mb-6">
                    Sei pronto per iniziare il test.
                  </p>
              ...
              {statoVolume === 'non-sentito' && (
                <div className="card-voicecheck text-center py-8 animate-fade-in-up">
                  ...
                  <p className="text-[#64748B] text-base mb-6">
                    Segui questi passi per alzare il volume:
                  </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <button className="btn-secondary text-sm" onClick={() => setStep('test')}>
